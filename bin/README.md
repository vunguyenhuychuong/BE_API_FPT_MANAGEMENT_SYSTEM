...
### Link Server: http://ec2-13-212-160-147.ap-southeast-1.compute.amazonaws.com/swagger-ui/index.html
### Link Swagger Local: http://localhost/swagger-ui/index.html#/
### Link Front-end: http://ec2-13-214-167-171.ap-southeast-1.compute.amazonaws.com/
...
```
cd existing_repo
git remote add origin https://gitlab.com/VienQuocBinh/java-08.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/VienQuocBinh/java-08/-/settings/integrations)
